...
public class RemoveServe {
  ...
  /*
     ...
     Part 1
             ...
             input 1: "0 0 1 0"
             input 2: remove_time = 2 (0 based index)
             when the server is shut down, there is a penalty of 1 since during time 2 and 3
             log 3 indicated it was on when it should have been off.
             penalty = 1

             Example 2
             "0 0 1 0" remove_time = 0 index
             penalty = 3
             log 0, 1 and 3 was on when it should have been off
     ...
     Part 2
             write another function to give logs
             find when is the best time to take the server down
  ...
  */
  ...
  Further Examples:
   ...
   hour : 1  2  3  4  // total penalty = 3 (1 server-down hour before remove + 1 server-up hour after remove)
     log: 1  0  1  0
               ^
               |
            remove_at = 2
